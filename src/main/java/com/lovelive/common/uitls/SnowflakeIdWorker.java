...
public class SnowflakeIdWorker {
    ...
    private SnowflakeIdWorker() {
        ...
        try {
            /*workerId = Long.parseLong(Global.getConfig("workerId"));
            datacenterId = Long.parseLong(Global.getConfig("datacenterId"));*/

            if (StringUtils.isNotBlank(System.getProperty("workerId"))) {
