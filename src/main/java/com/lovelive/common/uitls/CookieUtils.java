...
public class CookieUtils {
    ...
    public static void setCookie(HttpServletResponse response, String name, String value, int maxAge) {
        ...
        if (StringUtils.isNotBlank(SpringContextHolder.getApplicationContext().getApplicationName())) {
            path = SpringContextHolder.getApplicationContext().getApplicationName();
        }
     ...
     * @return 值
     */
    public static void reomveCookie(HttpServletRequest request, HttpServletResponse response, String name) {
