 ...
 */
package com.lovelive.sys.util;

import com.lovelive.common.util.NumberUtils;
import com.lovelive.common.util.PropertiesLoader;
...
public class Global {
    ...
    public static String getTipDisplayTime() {
        return getConfig("TipDisplayTime");
    }
