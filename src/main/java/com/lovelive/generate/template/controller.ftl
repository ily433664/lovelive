...
import com.dcampus.ccnl.common.config.Global;
import com.dcampus.ccnl.common.persistence.Page;
import com.dcampus.ccnl.common.web.BaseController;
import com.dcampus.ccnl.common.utils.StringUtils;
import com.dcampus.ccnl.modules.sys.entity.User;
import com.dcampus.ccnl.modules.sys.utils.UserUtils;
...
public class ${ClassName}Controller extends BaseController {
	...
	public String list(${ClassName} ${className}, HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        Page<${ClassName}> page = ${className}Service.find(new Page<${ClassName}>(request, response,"createDate","false"), ${className}); 
	...
	public String save(${ClassName} ${className}, Model model) {
		...
		addMessage(model, "保存${functionName}'" + ${className}.getName() + "'成功");
