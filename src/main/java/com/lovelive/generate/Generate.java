package com.lovelive.generate;

import com.google.common.collect.Maps;
import com.lovelive.common.uitls.DateUtils;
import com.lovelive.common.uitls.FileUtils;
import com.lovelive.common.uitls.FreemarkerUtils;
...
public class Generate {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String packageName = "com.lovelive";
        //Equipment allocation allocate  Equipment Scrap
        String moduleName = "sys";            // 模块名，例：sys
        String subModuleName = "";                // 子模块名（可选）
        String className = "OtherGraduationsNotice";            // 类名，例：user
        String classAuthor = "";        // 类作者，例：ThinkGem
        String functionName = "其他毕业去向须知";            // 功能名，例：用户
        ...
        // 模板文件路径
        String tplPath = StringUtils.replace(projectPath + "/src/com/dcampus/ccnl/generate/template", "/", separator);
